...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_ansi_69(
        ...
        KC_LCTL, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,              KC_H,    KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,           KC_HOME,
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,     KC_ESC,  KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        KC_LCTL, KC_LALT,  MO(_CMD),  KC_SPC,           MO(_FN1), MO(_FN1),         KC_SPC,           KC_RWIN,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_CMD] = LAYOUT_ansi_69(
        ...
        _______, A(KC_F4), C(KC_W),  _______, C(KC_R), C(KC_T), _______,  _______, _______, C(KC_O), _______,  _______,  _______,  _______,          _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [MAC_BASE] = {ENCODER_CCW_CW(LCA(KC_SPC), C(KC_SPC))},
    [WIN_BASE] = {ENCODER_CCW_CW(LGUI(KC_SPC), SGUI(KC_SPC))},
